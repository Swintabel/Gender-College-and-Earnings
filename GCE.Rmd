...
plot6+theme(panel.background = element_rect(fill = "white"))+labs(title="FIGURE 4: COLLEGE MAJORS AND GENDER", y="Total Number of Students")+theme(plot.title = element_text(hjust = 0.5, face = "bold", colour = "cadetblue"))+coord_flip()
...
plot5+theme(panel.background = element_rect(fill = "white"))+labs(title="FIGURE 5: COLLEGE MAJORS, GENDER AND EARNINGS", y="Median Earnings", x="Major Category")+theme(plot.title = element_text(hjust = 0.5, face = "bold", colour = "cadetblue"))+scale_y_continuous(labels = scales::dollar)+scale_fill_manual(values = c("steelblue","black","orange"))
```
